...
export const StyleCompositeurices = styled.main`
    padding: 15px;
    max-width: 2000px;
    min-height: 89vh;
    margin: auto;
    ...
    align-items: center;
`
export default function Compositeurices() {
    return (
        <React.Fragment>
            <StyleNavigationReduit>
                <Navigation />
            </StyleNavigationReduit>
            <StyleCompositeurices>
                <Helmet>
                    <title>Ensemble Syllepse - Les compositeurices</title>
                    <meta
                        name="description"
