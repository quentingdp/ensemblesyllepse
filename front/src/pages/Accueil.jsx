        ...
        <StyleAccueil>
            ...
            <article className="presentation-avec-photo">
                ...
                <p className="presentation-avec-photo-description">
                    Syllepse est un jeune ensemble vocal lyonnais constitué de
                    30 chanteurs aguerris, regroupés autour de la cheffe Ophélia
                    Besson. Chœur mixte a cappella, il fait le pari d'associer
                    musiques anciennes et contemporaines à destination d'un
                    large public. Réuni pour la première fois en 2020 pour un
                    programme Shakespearien, le chœur Syllepse fait résonner la
                    musique d'antan et celle d'aujourd'hui. Le plaisir, la
                    beauté alliés à l'exigence sont les lignes de force de
                    l'ensemble vocal Syllepse. L'ensemble vocal est géré par une
                    association d'intérêt général de promotion culturelle du
                    même nom (voir l'onglet « nous soutenir »)
                </p>
            </article>
            <article className="presentation-texte">
                ...
                <p className="presentation-texte-description">
                    ...
                    signifie littéralement : « action de prendre ensemble, de
                    comprendre, d'embrasser ».
                </p>
